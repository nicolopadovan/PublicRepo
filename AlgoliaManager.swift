...
class AlgoliaManager: NSObject {
    ...
    fileprivate static let apiKey: APIKey = APIKey(rawValue: SessionManager.shared.algoliaAPIKey)
    ...
    var hitsInteractor = HitsInteractor<Skill>(infiniteScrolling: .off, showItemsOnEmptyQuery: true)
...
//        }
    ...
    func unsubscribe() {
        ...
        hitsInteractor = HitsInteractor<Skill>(infiniteScrolling: .off, showItemsOnEmptyQuery: true)
